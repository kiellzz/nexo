...
export function StartupAnalysisPage({ startup: propStartup, pendingStartups = [] }: Props) {
  ...
  if (!targetStartup && id) {
    targetStartup = {
      ...
      formData: {
        ...
        sector: id === '1' ? 'Logística' : id === '2' ? 'Saúde Digital' : 'Energia Limpa',
        city: 'São Paulo - SP',
        website: 'empresa.com.br',
        description: 'Plataforma líder em otimização de frotas e alto crescimento.',
  ...
  const activeStartup = targetStartup ?? {
    ...
    formData: {
      ...
      sector: 'Logística',
      city: 'São Paulo - SP',
      website: 'novaflow.com.br',
      description: 'Plataforma de otimização de rotas para frotas corporativas.',
      annualRevenue: '1200000',
      momGrowth: '16',
      customerCount: '62',
      monthlyCosts: '70000',
